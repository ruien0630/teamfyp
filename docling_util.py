...
def create_chroma_vectordb(
    ...
    text_splitter_choice: str = "ContentAwareSplitting",
    splitter_para: dict = {},
    ...
    Args:
        ...
        text_splitter_choice (str): The type of text splitter to use. Supported choices are
                                    "ContentAwareSplitting", "CharacterTextSplitter", and "TokenTextSplitter".
                                    Defaults to "ContentAwareSplitting".
        splitter_para (dict): A dictionary of parameters for the text splitter.
                              For ContentAwareSplitting: max_tokens (default: 800)
                              For other splitters: chunk_size (default: 1000) and chunk_overlap (default: 200)
        ...
        if text_splitter_choice == "ContentAwareSplitting":
            ...
            for file_path in file_paths:
                ...
                for chunk in chunk_iter:
                    # Convert DocChunk to LangChain Document
                    doc = Document(
                        page_content=chunk.text,
                        metadata={
                            "source": file_path,
                            "headings": chunk.meta.headings if hasattr(chunk.meta, 'headings') else [],
                            "doc_items": str(chunk.meta.doc_items) if hasattr(chunk.meta, 'doc_items') else ""
                        }
                    )
                    chunks.append(doc)
            ...
            if text_splitter_choice == "CharacterTextSplitter":
                ...
                raise ValueError(
                    ...
                    "Supported splitters are 'ContentAwareSplitting', 'CharacterTextSplitter' and 'TokenTextSplitter'."
                )        
