...
def setup_qa_chain(
    ...
    prompt_template = """You are a helpful financial assistant.

Answer the question as fully and clearly as possible using the provided context.
If some information is missing, try to provide the closest relevant information
that may help the user understand the topic.
