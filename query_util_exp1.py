#Used WatsonxLLM and Chroma to create a RAG chain 
...
def setup_qa_chain(
    ...
    Args:
        ...
        use_local_path (bool): If True, the function will load the vector store from
         ...
         model_id (str): The ID of the language model to use. Currently, only
                        'ibm/granite-4-h-small' is supported.
    ...
    if model_id == "ibm/granite-4-h-small":
        # Step 1: Configure IBM Granite model
        llm = WatsonxLLM(
            url="https://us-south.ml.cloud.ibm.com",
            # apikey=os.environ.get("WATSONX_APIKEY"),
            project_id=os.environ.get("IBM_PROJECT_ID"), # project id called from env
            model_id=model_id,
            params={
                "temperature": 0.1,
                "max_new_tokens": 512,
        ...
        raise ValueError("Only 'ibm/granite-4-h-small' is currently supported.")
